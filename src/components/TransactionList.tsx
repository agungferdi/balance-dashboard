...
import { Trash2, Utensils, Car, Wrench, Gamepad2, Banknote, MoreHorizontal, Clock } from 'lucide-react';
...
const TransactionList: React.FC<TransactionListProps> = ({ transactions, loading, onDelete }) => {
  if (loading) {
    return (

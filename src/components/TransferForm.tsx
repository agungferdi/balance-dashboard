...
const TransferForm: React.FC<TransferFormProps> = ({ onSubmit, loading, accountBalances }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#1a1a24] rounded-2xl p-6 shadow-sm dark:shadow-[0_0_30px_rgba(59,130,246,0.06)] border border-gray-100 dark:border-white/5 transition-colors duration-300">
